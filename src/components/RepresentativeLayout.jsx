...
const representativeMenuItems = [
  { icon: LayoutDashboard, label: "Dashboard", labelAr: "لوحة التحكم", path: "/representative/dashboard" },
  { icon: UserCheck, label: "Clients", labelAr: "العملاء", path: "/representative/clients" },
  { icon: Package, label: "Products", labelAr: "المنتجات", path: "/representative/products" },
  { icon: Calendar, label: "Visits", labelAr: "الزيارات", path: "/representative/visits" },
  { icon: ClipboardList, label: "Orders", labelAr: "الطلبات", path: "/representative/orders" },
  { icon: BarChart3, label: "Reports", labelAr: "التقارير", path: "/representative/reports" },
  { icon: Wallet, label: "Wallet", labelAr: "المحفظة", path: "/representative/wallet" },
  { icon: Settings, label: "Settings", labelAr: "الإعدادات", path: "/representative/settings" },
];
    ...
    <div className="flex flex-col h-full" dir={isRTL ? "rtl" : "ltr"}>
      ...
      <div className="h-16 flex items-center justify-center border-b border flex-shrink-0">
        ...
        >
          ...
          >
            {isRTL ? "بوابة المندوب" : "Representative Portal"}
          </span>
        </motion.div>
        {onClose && (
          <motion.button
      ...
      <div className="p-4 border-b border">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <p className="font-medium text-sm truncate">{user?.username || "Representative"}</p>
      ...
      <nav className="flex-1 overflow-y-auto p-4 space-y-1">
        {representativeMenuItems.map((item, index) => {
          const Icon = item.icon;
          const isActive = location.pathname === item.path || (item.path !== "/representative/dashboard" && location.pathname.startsWith(item.path));
